...
def main(pca_dims, rate, sensor):
    ...
    with open('testing_others_results_acc.txt', 'a', newline='') as f_out:
...
if __name__ == '__main__':
    ...
    with open('testing_others_results_acc.txt', 'w', newline='') as f_out:
        writer = csv.writer(f_out)
        writer.writerow(
