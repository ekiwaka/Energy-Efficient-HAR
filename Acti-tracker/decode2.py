...
if __name__ == '__main__':
    ...
    for pca_dims in x:
        for compress_rate in y:
            ...
            weight_file = 'model/' + moderated + 'Hz/pruned/' + 'compressed_pca=' + str(
                pca_dims) + '_compress_rate=' + str(compress_rate) + '.h5'
            ...
            model.save(
                'model/' + moderated + 'Hz/pruned/' + 'decompressed_pca=' + str(pca_dims) + '_compress_rate=' + str(
                    compress_rate) + '.hdf5')
